...
private:
	...
	// Output file names ... added aboveground litter,aaet,lai by weichao
	xtring file_yield, file_yield1, file_yield2, file_sdate1, file_sdate2,
		   ...
		   file_cpool_forest, file_clitter_ag_natural, file_clitter_ag_forest,file_height_natural, file_height_forest,
		   file_aaet_natural, file_aaet_forest, file_lai_natural, file_lai_forest, file_nflux_cropland, file_nflux_pasture,
		   file_P_m_natural, file_P_m_forest, file_P_mCK_natural, file_P_mCK_forest, file_P_mtau_natural, file_P_mtau_forest,
		   file_diameter_natural, file_diameter_forest, file_barkt_natural, file_barkt_forest, file_crownlength_natural, file_crownlength_forest,
		   file_nflux_natural, file_nflux_forest, file_npool_cropland, file_npool_pasture, file_npool_natural, file_npool_forest,
		   file_anpp_cropland, file_anpp_pasture, file_anpp_natural, file_anpp_forest, file_agpp_natural, file_agpp_forest,
		   file_ROS_natural, file_ROS_forest, file_scorchHeight_natural, file_scorchHeight_forest,
		   file_cmass_cropland, file_cmass_pasture, file_cmass_natural, file_cmass_forest, file_dens_natural,
		   file_dens_forest;
	...
	Table out_yield, out_yield1, out_yield2, out_sdate1, out_sdate2,
		  ...
		  out_cpool_forest,out_clitter_ag_natural, out_clitter_ag_forest, out_height_natural, out_height_forest,
		  out_aaet_natural, out_aaet_forest, out_lai_natural, out_lai_forest, out_nflux_cropland, out_nflux_pasture,
		  out_P_m_natural, out_P_m_forest,out_P_mCK_natural, out_P_mCK_forest,out_P_mtau_natural, out_P_mtau_forest,
		  out_diameter_natural, out_diameter_forest,out_barkt_natural, out_barkt_forest,out_crownlenght_natural, out_crownlenght_forest,
		  out_nflux_natural, out_nflux_forest, out_npool_cropland, out_npool_pasture, out_npool_natural, out_npool_forest,
		  out_anpp_cropland, out_anpp_pasture, out_anpp_natural, out_anpp_forest, out_agpp_natural, out_agpp_forest,
		  out_ROS_natural, out_ROS_forest, out_scorchHeight_natural, out_scorchHeight_forest,
		  out_cmass_cropland, out_cmass_pasture, out_cmass_natural, out_cmass_forest, out_dens_natural, 
		  out_dens_forest;

	Table out_anpp_stand_natural[MAXNUMBER_STANDS];
	Table out_agpp_stand_natural[MAXNUMBER_STANDS]; // added by weichao	
	Table out_cmass_stand_natural[MAXNUMBER_STANDS];
	Table out_anpp_stand_forest[MAXNUMBER_STANDS];
	Table out_agpp_stand_forest[MAXNUMBER_STANDS];  // added by weichao	
