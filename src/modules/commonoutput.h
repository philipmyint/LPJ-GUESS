...
private:
	...
	// Output file names ...add clitter aboveground
	xtring file_cmass,file_anpp,file_agpp,file_fpc,file_aaet,file_dens,file_lai,file_cflux,file_doc,file_cpool,file_clitter,file_clitter_ag,file_runoff;
	...
	// Output tables
	Table out_cmass, out_anpp, out_agpp, out_fpc, out_aaet, out_dens, out_lai, out_cflux, out_doc, out_cpool, out_clitter,out_clitter_ag, out_firert, out_runoff, out_speciesheights;
