...
// added by weichao
	double SURFMETA_cmass;
	double SURFSTRUCT_cmass;
	double SOILMETA_cmass;
	double SOILSTRUCT_cmass;
	double SURFFWD_cmass;
	double SURFCWD_cmass;
// end
	...
	Harvest_CN() {
		...
		// litter_leaf = litter_root = litter_sap = litter_heart = litter_wood = 0.0; // added litter_wood by weichao
		litter_leaf = litter_root = litter_sap = litter_heart = 0.0;
		// added by weichao
		SURFMETA_cmass = SURFSTRUCT_cmass = SOILMETA_cmass = SOILSTRUCT_cmass = SURFFWD_cmass = SURFCWD_cmass = 0.0;
		// end
...
// added by weichao
            SURFMETA_cmass = patch.soil.sompool[SURFMETA].cmass;
            SURFSTRUCT_cmass = patch.soil.sompool[SURFSTRUCT].cmass;
            SOILMETA_cmass = patch.soil.sompool[SOILMETA].cmass;
            SOILSTRUCT_cmass = patch.soil.sompool[SOILSTRUCT].cmass;
            SURFFWD_cmass = patch.soil.sompool[SURFFWD].cmass;
            SURFCWD_cmass = patch.soil.sompool[SURFCWD].cmass;
// end
...
// added by weichao
        patch.soil.sompool[SURFMETA].cmass = SURFMETA_cmass;
        patch.soil.sompool[SURFSTRUCT].cmass = SURFSTRUCT_cmass;
        patch.soil.sompool[SOILMETA].cmass = SOILMETA_cmass;
        patch.soil.sompool[SOILSTRUCT].cmass = SOILSTRUCT_cmass;
        patch.soil.sompool[SURFFWD].cmass = SURFFWD_cmass;
        patch.soil.sompool[SURFCWD].cmass = SURFCWD_cmass;
// end
