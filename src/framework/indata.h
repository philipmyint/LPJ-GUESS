...
public:
	...
	int ifmanaged; //@GA
	int ifdisturbyr; //@KE whether gridcell disturbed this year or not
//	bool ifincept; //@KE whether gridcell has inceptisol soil or not
	xtring descrip; //@KE this is the gridlist number
};
