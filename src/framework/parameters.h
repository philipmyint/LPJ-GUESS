...
typedef enum {LPJFIRE, LMFIRE, LMFIRE_CF, NOFIRE} firemodetype;
// Added when created LMFire - @KE
// whether to use LPJ fire routine "LPJFIRE", LMFire routine "LMFIRE",
// LMFire with @KE added crown fire routine "LMFIRE_CF", or "NOFIRE" to turn fire off
...
extern firemodetype firemode; // Added for use of LMFire - @KE added 2018
// whether to use LPJ fire routine "LPJFIRE", LMFire routine "LMFIRE",
// LMFire with @KE added crown fire routine "LMFIRE_CF", or "NOFIRE" to turn fire off
