...
# /home/pmyint/Environmental_Management/src_LPJ_GUESS/build/guess
# as a parallel job using PBS on Simba.
#
# Created automatically on Sun Aug 18 06:40:28 PDT 2024
# 
# Usage: 
#
...
mpiexec -comm mpich-p4 /home/pmyint/Environmental_Management/src_LPJ_GUESS/build/guess -parallel -input $INPUT_MODULE $INSFILE
